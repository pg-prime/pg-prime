/**
 * `pgormjs` — the public surface. One import for an application file.
 *
 * ## Curated, not `export *`
 *
 ...
 *   query    — `pgOrm`, `compileOnly`, the ~90 operators, `fn.*`, `nest`, `over`
...
export type { IdentRejectReason, PgOrmErrorCode } from './sql/index.js'
...
export { compileOnly, pgOrm } from './query/run.js'
export type { PgOrmOptions } from './query/run.js'
