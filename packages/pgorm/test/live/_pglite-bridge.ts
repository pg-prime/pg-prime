...
/**
 * `PGORM_BRIDGE_TRACE=<file>` appends every message type in and out to that file — how the
 ...
 */
const TRACE = process.env['PGORM_BRIDGE_TRACE']
...
/** `T33 D11 C13 Z5` — message types and lengths, for `PGORM_BRIDGE_TRACE`. */
