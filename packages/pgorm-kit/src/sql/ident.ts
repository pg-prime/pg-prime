 ...
 *
 * This is a deliberate, self-contained PORT of `pgormjs`'s `sql/ident.ts` rather than an
 * import: `pgormjs` has no build output or entry point yet, and the kit must not take a
...
export class InvalidIdentifierError extends Error {
  readonly code = "PGORM_INVALID_IDENTIFIER";
  constructor(
