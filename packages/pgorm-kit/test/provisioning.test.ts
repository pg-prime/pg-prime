...
const TARGET = "pgorm_prov_target";
const DESIRED = "pgorm_prov_desired";
const SOURCE_SHADOW = "pgorm_shadow_prov_src";
const T = 180_000;
...
describe("shadow provisioning never disconnects or destroys what it did not create", () => {
  ...
  it("terminateConnections refuses any database this tool did not provision", async () => {
    expect(isShadowDatabase("pgorm_shadow_ab12")).toBe(true);
    expect(isShadowDatabase("pgorm_shadow_")).toBe(false);
