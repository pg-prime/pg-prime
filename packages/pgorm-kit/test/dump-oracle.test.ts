...
describe("pg_dump oracle against live PostgreSQL", () => {
  ...
  describe("a converged plan also dumps identically", () => {
    const DESIRED = "pgorm_dump_acc_desired";
    const TARGET = "pgorm_dump_acc_target";
  ...
  describe("column order on a live migration", () => {
    const CURRENT = "pgorm_dump_evolve_current";
    const DESIRED = "pgorm_dump_evolve_desired";
  ...
  describe("blind spot: a difference the IR cannot represent", () => {
    const CURRENT = "pgorm_dump_blind_current";
    const DESIRED = "pgorm_dump_blind_desired";
