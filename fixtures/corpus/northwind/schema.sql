-- pg-prime:corpus northwind
-- Source: https://raw.githubusercontent.com/pthom/northwind_psql/cd0ef28d66369fbe177778e604e4be0f153c9e5c/northwind.sql
-- sha256(upstream): 0ee30c01ba282f7194f38bf7f99cd6be0470b7ee5f67d0f7ca41fb058d735e0c
-- Licence: MIT — see LICENSE beside this file.
--
-- TRIMMED to schema-only DDL by tools/corpus-fetch.mjs. Regenerate with:
--   node tools/corpus-fetch.mjs northwind
-- Dropped: 3362×INSERT INTO
...
ALTER TABLE ONLY customer_customer_demo ADD CONSTRAINT fk_customer_customer_demo_customer_demographics FOREIGN KEY (customer_type_id) REFERENCES customer_demographics;

ALTER TABLE ONLY customer_customer_demo ADD CONSTRAINT fk_customer_customer_demo_customers FOREIGN KEY (customer_id) REFERENCES customers;
