-- pg-prime:corpus adventureworks
-- Source: https://raw.githubusercontent.com/lorint/AdventureWorks-for-Postgres/b474991f0df1c4bf55ca4735eb0254ca0709eed2/install.sql
-- sha256(upstream): 27f71c99365aa5f44dba5d3b7ca092a654fcf50e6931c4dbe96ba2a13f8b7e0e
-- Licence: MIT — see LICENSE beside this file.
--
-- TRIMMED to schema-only DDL by tools/corpus-fetch.mjs. Regenerate with:
--   node tools/corpus-fetch.mjs adventureworks
-- Dropped: 1×INSERT INTO, 1×UPDATE PERSON
...
CREATE SCHEMA Person CREATE TABLE BusinessEntity( BusinessEntityID SERIAL, rowguid uuid NOT NULL CONSTRAINT "DF_BusinessEntity_rowguid" DEFAULT (uuid_generate_v1()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_BusinessEntity_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE Person( BusinessEntityID INT NOT NULL, PersonType char(2) NOT NULL, NameStyle "NameStyle" NOT NULL CONSTRAINT "DF_Person_NameStyle" DEFAULT (false), Title varchar(8) NULL, FirstName "Name" NOT NULL, MiddleName "Name" NULL, LastName "Name" NOT NULL, Suffix varchar(10) NULL, EmailPromotion INT NOT NULL CONSTRAINT "DF_Person_EmailPromotion" DEFAULT (0), AdditionalContactInfo XML NULL, Demographics XML NULL, rowguid uuid NOT NULL CONSTRAINT "DF_Person_rowguid" DEFAULT (uuid_generate_v1()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_Person_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_Person_EmailPromotion" CHECK (EmailPromotion BETWEEN 0 AND 2), CONSTRAINT "CK_Person_PersonType" CHECK (PersonType IS NULL OR UPPER(PersonType) IN ('SC', 'VC', 'IN', 'EM', 'SP', 'GC')) ) CREATE TABLE StateProvince( StateProvinceID SERIAL, StateProvinceCode char(3) NOT NULL, CountryRegionCode varchar(3) NOT NULL, IsOnlyStateProvinceFlag "Flag" NOT NULL CONSTRAINT "DF_StateProvince_IsOnlyStateProvinceFlag" DEFAULT (true), Name "Name" NOT NULL, TerritoryID INT NOT NULL, rowguid uuid NOT NULL CONSTRAINT "DF_StateProvince_rowguid" DEFAULT (uuid_generate_v1()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_StateProvince_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE Address( AddressID SERIAL, AddressLine1 varchar(60) NOT NULL, AddressLine2 varchar(60) NULL, City varchar(30) NOT NULL, StateProvinceID INT NOT NULL, PostalCode varchar(15) NOT NULL, SpatialLocation bytea NULL, rowguid uuid NOT NULL CONSTRAINT "DF_Address_rowguid" DEFAULT (uuid_generate_v1()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_Address_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE AddressType( AddressTypeID SERIAL, Name "Name" NOT NULL, rowguid uuid NOT NULL CONSTRAINT "DF_AddressType_rowguid" DEFAULT (uuid_generate_v1()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_AddressType_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE BusinessEntityAddress( BusinessEntityID INT NOT NULL, AddressID INT NOT NULL, AddressTypeID INT NOT NULL, rowguid uuid NOT NULL CONSTRAINT "DF_BusinessEntityAddress_rowguid" DEFAULT (uuid_generate_v1()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_BusinessEntityAddress_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE ContactType( ContactTypeID SERIAL, Name "Name" NOT NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_ContactType_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE BusinessEntityContact( BusinessEntityID INT NOT NULL, PersonID INT NOT NULL, ContactTypeID INT NOT NULL, rowguid uuid NOT NULL CONSTRAINT "DF_BusinessEntityContact_rowguid" DEFAULT (uuid_generate_v1()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_BusinessEntityContact_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE EmailAddress( BusinessEntityID INT NOT NULL, EmailAddressID SERIAL, EmailAddress varchar(50) NULL, rowguid uuid NOT NULL CONSTRAINT "DF_EmailAddress_rowguid" DEFAULT (uuid_generate_v1()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_EmailAddress_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE Password( BusinessEntityID INT NOT NULL, PasswordHash VARCHAR(128) NOT NULL, PasswordSalt VARCHAR(10) NOT NULL, rowguid uuid NOT NULL CONSTRAINT "DF_Password_rowguid" DEFAULT (uuid_generate_v1()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_Password_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE PhoneNumberType( PhoneNumberTypeID SERIAL, Name "Name" NOT NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_PhoneNumberType_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE PersonPhone( BusinessEntityID INT NOT NULL, PhoneNumber "Phone" NOT NULL, PhoneNumberTypeID INT NOT NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_PersonPhone_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE CountryRegion( CountryRegionCode varchar(3) NOT NULL, Name "Name" NOT NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_CountryRegion_ModifiedDate" DEFAULT (NOW()) );
...
CREATE SCHEMA HumanResources CREATE TABLE Department( DepartmentID SERIAL NOT NULL, Name "Name" NOT NULL, GroupName "Name" NOT NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_Department_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE Employee( BusinessEntityID INT NOT NULL, NationalIDNumber varchar(15) NOT NULL, LoginID varchar(256) NOT NULL, Org varchar NULL, OrganizationLevel INT NULL, JobTitle varchar(50) NOT NULL, BirthDate DATE NOT NULL, MaritalStatus char(1) NOT NULL, Gender char(1) NOT NULL, HireDate DATE NOT NULL, SalariedFlag "Flag" NOT NULL CONSTRAINT "DF_Employee_SalariedFlag" DEFAULT (true), VacationHours smallint NOT NULL CONSTRAINT "DF_Employee_VacationHours" DEFAULT (0), SickLeaveHours smallint NOT NULL CONSTRAINT "DF_Employee_SickLeaveHours" DEFAULT (0), CurrentFlag "Flag" NOT NULL CONSTRAINT "DF_Employee_CurrentFlag" DEFAULT (true), rowguid uuid NOT NULL CONSTRAINT "DF_Employee_rowguid" DEFAULT (uuid_generate_v1()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_Employee_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_Employee_BirthDate" CHECK (BirthDate BETWEEN '1930-01-01' AND NOW() - INTERVAL '18 years'), CONSTRAINT "CK_Employee_MaritalStatus" CHECK (UPPER(MaritalStatus) IN ('M', 'S')), CONSTRAINT "CK_Employee_HireDate" CHECK (HireDate BETWEEN '1996-07-01' AND NOW() + INTERVAL '1 day'), CONSTRAINT "CK_Employee_Gender" CHECK (UPPER(Gender) IN ('M', 'F')), CONSTRAINT "CK_Employee_VacationHours" CHECK (VacationHours BETWEEN -40 AND 240), CONSTRAINT "CK_Employee_SickLeaveHours" CHECK (SickLeaveHours BETWEEN 0 AND 120) ) CREATE TABLE EmployeeDepartmentHistory( BusinessEntityID INT NOT NULL, DepartmentID smallint NOT NULL, ShiftID smallint NOT NULL, StartDate DATE NOT NULL, EndDate DATE NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_EmployeeDepartmentHistory_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_EmployeeDepartmentHistory_EndDate" CHECK ((EndDate >= StartDate) OR (EndDate IS NULL)) ) CREATE TABLE EmployeePayHistory( BusinessEntityID INT NOT NULL, RateChangeDate TIMESTAMP NOT NULL, Rate numeric NOT NULL, PayFrequency smallint NOT NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_EmployeePayHistory_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_EmployeePayHistory_PayFrequency" CHECK (PayFrequency IN (1, 2)), CONSTRAINT "CK_EmployeePayHistory_Rate" CHECK (Rate BETWEEN 6.50 AND 200.00) ) CREATE TABLE JobCandidate( JobCandidateID SERIAL NOT NULL, BusinessEntityID INT NULL, Resume XML NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_JobCandidate_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE Shift( ShiftID SERIAL NOT NULL, Name "Name" NOT NULL, StartTime time NOT NULL, EndTime time NOT NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_Shift_ModifiedDate" DEFAULT (NOW()) );
...
CREATE SCHEMA Production CREATE TABLE BillOfMaterials( BillOfMaterialsID SERIAL NOT NULL, ProductAssemblyID INT NULL, ComponentID INT NOT NULL, StartDate TIMESTAMP NOT NULL CONSTRAINT "DF_BillOfMaterials_StartDate" DEFAULT (NOW()), EndDate TIMESTAMP NULL, UnitMeasureCode char(3) NOT NULL, BOMLevel smallint NOT NULL, PerAssemblyQty decimal(8, 2) NOT NULL CONSTRAINT "DF_BillOfMaterials_PerAssemblyQty" DEFAULT (1.00), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_BillOfMaterials_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_BillOfMaterials_EndDate" CHECK ((EndDate > StartDate) OR (EndDate IS NULL)), CONSTRAINT "CK_BillOfMaterials_ProductAssemblyID" CHECK (ProductAssemblyID <> ComponentID), CONSTRAINT "CK_BillOfMaterials_BOMLevel" CHECK (((ProductAssemblyID IS NULL) AND (BOMLevel = 0) AND (PerAssemblyQty = 1.00)) OR ((ProductAssemblyID IS NOT NULL) AND (BOMLevel >= 1))), CONSTRAINT "CK_BillOfMaterials_PerAssemblyQty" CHECK (PerAssemblyQty >= 1.00) ) CREATE TABLE Culture( CultureID char(6) NOT NULL, Name "Name" NOT NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_Culture_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE Document( Doc varchar NULL, DocumentLevel INTEGER, Title varchar(50) NOT NULL, Owner INT NOT NULL, FolderFlag "Flag" NOT NULL CONSTRAINT "DF_Document_FolderFlag" DEFAULT (false), FileName varchar(400) NOT NULL, FileExtension varchar(8) NULL, Revision char(5) NOT NULL, ChangeNumber INT NOT NULL CONSTRAINT "DF_Document_ChangeNumber" DEFAULT (0), Status smallint NOT NULL, DocumentSummary text NULL, Document bytea NULL, rowguid uuid NOT NULL UNIQUE CONSTRAINT "DF_Document_rowguid" DEFAULT (uuid_generate_v1()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_Document_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_Document_Status" CHECK (Status BETWEEN 1 AND 3) ) CREATE TABLE ProductCategory( ProductCategoryID SERIAL NOT NULL, Name "Name" NOT NULL, rowguid uuid NOT NULL CONSTRAINT "DF_ProductCategory_rowguid" DEFAULT (uuid_generate_v1()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_ProductCategory_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE ProductSubcategory( ProductSubcategoryID SERIAL NOT NULL, ProductCategoryID INT NOT NULL, Name "Name" NOT NULL, rowguid uuid NOT NULL CONSTRAINT "DF_ProductSubcategory_rowguid" DEFAULT (uuid_generate_v1()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_ProductSubcategory_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE ProductModel( ProductModelID SERIAL NOT NULL, Name "Name" NOT NULL, CatalogDescription XML NULL, Instructions XML NULL, rowguid uuid NOT NULL CONSTRAINT "DF_ProductModel_rowguid" DEFAULT (uuid_generate_v1()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_ProductModel_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE Product( ProductID SERIAL NOT NULL, Name "Name" NOT NULL, ProductNumber varchar(25) NOT NULL, MakeFlag "Flag" NOT NULL CONSTRAINT "DF_Product_MakeFlag" DEFAULT (true), FinishedGoodsFlag "Flag" NOT NULL CONSTRAINT "DF_Product_FinishedGoodsFlag" DEFAULT (true), Color varchar(15) NULL, SafetyStockLevel smallint NOT NULL, ReorderPoint smallint NOT NULL, StandardCost numeric NOT NULL, ListPrice numeric NOT NULL, Size varchar(5) NULL, SizeUnitMeasureCode char(3) NULL, WeightUnitMeasureCode char(3) NULL, Weight decimal(8, 2) NULL, DaysToManufacture INT NOT NULL, ProductLine char(2) NULL, Class char(2) NULL, Style char(2) NULL, ProductSubcategoryID INT NULL, ProductModelID INT NULL, SellStartDate TIMESTAMP NOT NULL, SellEndDate TIMESTAMP NULL, DiscontinuedDate TIMESTAMP NULL, rowguid uuid NOT NULL CONSTRAINT "DF_Product_rowguid" DEFAULT (uuid_generate_v1()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_Product_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_Product_SafetyStockLevel" CHECK (SafetyStockLevel > 0), CONSTRAINT "CK_Product_ReorderPoint" CHECK (ReorderPoint > 0), CONSTRAINT "CK_Product_StandardCost" CHECK (StandardCost >= 0.00), CONSTRAINT "CK_Product_ListPrice" CHECK (ListPrice >= 0.00), CONSTRAINT "CK_Product_Weight" CHECK (Weight > 0.00), CONSTRAINT "CK_Product_DaysToManufacture" CHECK (DaysToManufacture >= 0), CONSTRAINT "CK_Product_ProductLine" CHECK (UPPER(ProductLine) IN ('S', 'T', 'M', 'R') OR ProductLine IS NULL), CONSTRAINT "CK_Product_Class" CHECK (UPPER(Class) IN ('L', 'M', 'H') OR Class IS NULL), CONSTRAINT "CK_Product_Style" CHECK (UPPER(Style) IN ('W', 'M', 'U') OR Style IS NULL), CONSTRAINT "CK_Product_SellEndDate" CHECK ((SellEndDate >= SellStartDate) OR (SellEndDate IS NULL)) ) CREATE TABLE ProductCostHistory( ProductID INT NOT NULL, StartDate TIMESTAMP NOT NULL, EndDate TIMESTAMP NULL, StandardCost numeric NOT NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_ProductCostHistory_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_ProductCostHistory_EndDate" CHECK ((EndDate >= StartDate) OR (EndDate IS NULL)), CONSTRAINT "CK_ProductCostHistory_StandardCost" CHECK (StandardCost >= 0.00) ) CREATE TABLE ProductDescription( ProductDescriptionID SERIAL NOT NULL, Description varchar(400) NOT NULL, rowguid uuid NOT NULL CONSTRAINT "DF_ProductDescription_rowguid" DEFAULT (uuid_generate_v1()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_ProductDescription_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE ProductDocument( ProductID INT NOT NULL, Doc varchar NOT NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_ProductDocument_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE Location( LocationID SERIAL NOT NULL, Name "Name" NOT NULL, CostRate numeric NOT NULL CONSTRAINT "DF_Location_CostRate" DEFAULT (0.00), Availability decimal(8, 2) NOT NULL CONSTRAINT "DF_Location_Availability" DEFAULT (0.00), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_Location_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_Location_CostRate" CHECK (CostRate >= 0.00), CONSTRAINT "CK_Location_Availability" CHECK (Availability >= 0.00) ) CREATE TABLE ProductInventory( ProductID INT NOT NULL, LocationID smallint NOT NULL, Shelf varchar(10) NOT NULL, Bin smallint NOT NULL, Quantity smallint NOT NULL CONSTRAINT "DF_ProductInventory_Quantity" DEFAULT (0), rowguid uuid NOT NULL CONSTRAINT "DF_ProductInventory_rowguid" DEFAULT (uuid_generate_v1()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_ProductInventory_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_ProductInventory_Bin" CHECK (Bin BETWEEN 0 AND 100) ) CREATE TABLE ProductListPriceHistory( ProductID INT NOT NULL, StartDate TIMESTAMP NOT NULL, EndDate TIMESTAMP NULL, ListPrice numeric NOT NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_ProductListPriceHistory_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_ProductListPriceHistory_EndDate" CHECK ((EndDate >= StartDate) OR (EndDate IS NULL)), CONSTRAINT "CK_ProductListPriceHistory_ListPrice" CHECK (ListPrice > 0.00) ) CREATE TABLE Illustration( IllustrationID SERIAL NOT NULL, Diagram XML NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_Illustration_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE ProductModelIllustration( ProductModelID INT NOT NULL, IllustrationID INT NOT NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_ProductModelIllustration_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE ProductModelProductDescriptionCulture( ProductModelID INT NOT NULL, ProductDescriptionID INT NOT NULL, CultureID char(6) NOT NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_ProductModelProductDescriptionCulture_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE ProductPhoto( ProductPhotoID SERIAL NOT NULL, ThumbNailPhoto bytea NULL, ThumbnailPhotoFileName varchar(50) NULL, LargePhoto bytea NULL, LargePhotoFileName varchar(50) NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_ProductPhoto_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE ProductProductPhoto( ProductID INT NOT NULL, ProductPhotoID INT NOT NULL, "primary" "Flag" NOT NULL CONSTRAINT "DF_ProductProductPhoto_Primary" DEFAULT (false), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_ProductProductPhoto_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE ProductReview( ProductReviewID SERIAL NOT NULL, ProductID INT NOT NULL, ReviewerName "Name" NOT NULL, ReviewDate TIMESTAMP NOT NULL CONSTRAINT "DF_ProductReview_ReviewDate" DEFAULT (NOW()), EmailAddress varchar(50) NOT NULL, Rating INT NOT NULL, Comments varchar(3850), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_ProductReview_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_ProductReview_Rating" CHECK (Rating BETWEEN 1 AND 5) ) CREATE TABLE ScrapReason( ScrapReasonID SERIAL NOT NULL, Name "Name" NOT NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_ScrapReason_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE TransactionHistory( TransactionID SERIAL NOT NULL, ProductID INT NOT NULL, ReferenceOrderID INT NOT NULL, ReferenceOrderLineID INT NOT NULL CONSTRAINT "DF_TransactionHistory_ReferenceOrderLineID" DEFAULT (0), TransactionDate TIMESTAMP NOT NULL CONSTRAINT "DF_TransactionHistory_TransactionDate" DEFAULT (NOW()), TransactionType char(1) NOT NULL, Quantity INT NOT NULL, ActualCost numeric NOT NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_TransactionHistory_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_TransactionHistory_TransactionType" CHECK (UPPER(TransactionType) IN ('W', 'S', 'P')) ) CREATE TABLE TransactionHistoryArchive( TransactionID INT NOT NULL, ProductID INT NOT NULL, ReferenceOrderID INT NOT NULL, ReferenceOrderLineID INT NOT NULL CONSTRAINT "DF_TransactionHistoryArchive_ReferenceOrderLineID" DEFAULT (0), TransactionDate TIMESTAMP NOT NULL CONSTRAINT "DF_TransactionHistoryArchive_TransactionDate" DEFAULT (NOW()), TransactionType char(1) NOT NULL, Quantity INT NOT NULL, ActualCost numeric NOT NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_TransactionHistoryArchive_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_TransactionHistoryArchive_TransactionType" CHECK (UPPER(TransactionType) IN ('W', 'S', 'P')) ) CREATE TABLE UnitMeasure( UnitMeasureCode char(3) NOT NULL, Name "Name" NOT NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_UnitMeasure_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE WorkOrder( WorkOrderID SERIAL NOT NULL, ProductID INT NOT NULL, OrderQty INT NOT NULL, StockedQty INT, ScrappedQty smallint NOT NULL, StartDate TIMESTAMP NOT NULL, EndDate TIMESTAMP NULL, DueDate TIMESTAMP NOT NULL, ScrapReasonID smallint NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_WorkOrder_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_WorkOrder_OrderQty" CHECK (OrderQty > 0), CONSTRAINT "CK_WorkOrder_ScrappedQty" CHECK (ScrappedQty >= 0), CONSTRAINT "CK_WorkOrder_EndDate" CHECK ((EndDate >= StartDate) OR (EndDate IS NULL)) ) CREATE TABLE WorkOrderRouting( WorkOrderID INT NOT NULL, ProductID INT NOT NULL, OperationSequence smallint NOT NULL, LocationID smallint NOT NULL, ScheduledStartDate TIMESTAMP NOT NULL, ScheduledEndDate TIMESTAMP NOT NULL, ActualStartDate TIMESTAMP NULL, ActualEndDate TIMESTAMP NULL, ActualResourceHrs decimal(9, 4) NULL, PlannedCost numeric NOT NULL, ActualCost numeric NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_WorkOrderRouting_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_WorkOrderRouting_ScheduledEndDate" CHECK (ScheduledEndDate >= ScheduledStartDate), CONSTRAINT "CK_WorkOrderRouting_ActualEndDate" CHECK ((ActualEndDate >= ActualStartDate) OR (ActualEndDate IS NULL) OR (ActualStartDate IS NULL)), CONSTRAINT "CK_WorkOrderRouting_ActualResourceHrs" CHECK (ActualResourceHrs >= 0.0000), CONSTRAINT "CK_WorkOrderRouting_PlannedCost" CHECK (PlannedCost > 0.00), CONSTRAINT "CK_WorkOrderRouting_ActualCost" CHECK (ActualCost > 0.00) );
...
CREATE SCHEMA Purchasing CREATE TABLE ProductVendor( ProductID INT NOT NULL, BusinessEntityID INT NOT NULL, AverageLeadTime INT NOT NULL, StandardPrice numeric NOT NULL, LastReceiptCost numeric NULL, LastReceiptDate TIMESTAMP NULL, MinOrderQty INT NOT NULL, MaxOrderQty INT NOT NULL, OnOrderQty INT NULL, UnitMeasureCode char(3) NOT NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_ProductVendor_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_ProductVendor_AverageLeadTime" CHECK (AverageLeadTime >= 1), CONSTRAINT "CK_ProductVendor_StandardPrice" CHECK (StandardPrice > 0.00), CONSTRAINT "CK_ProductVendor_LastReceiptCost" CHECK (LastReceiptCost > 0.00), CONSTRAINT "CK_ProductVendor_MinOrderQty" CHECK (MinOrderQty >= 1), CONSTRAINT "CK_ProductVendor_MaxOrderQty" CHECK (MaxOrderQty >= 1), CONSTRAINT "CK_ProductVendor_OnOrderQty" CHECK (OnOrderQty >= 0) ) CREATE TABLE PurchaseOrderDetail( PurchaseOrderID INT NOT NULL, PurchaseOrderDetailID SERIAL NOT NULL, DueDate TIMESTAMP NOT NULL, OrderQty smallint NOT NULL, ProductID INT NOT NULL, UnitPrice numeric NOT NULL, LineTotal numeric, ReceivedQty decimal(8, 2) NOT NULL, RejectedQty decimal(8, 2) NOT NULL, StockedQty numeric, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_PurchaseOrderDetail_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_PurchaseOrderDetail_OrderQty" CHECK (OrderQty > 0), CONSTRAINT "CK_PurchaseOrderDetail_UnitPrice" CHECK (UnitPrice >= 0.00), CONSTRAINT "CK_PurchaseOrderDetail_ReceivedQty" CHECK (ReceivedQty >= 0.00), CONSTRAINT "CK_PurchaseOrderDetail_RejectedQty" CHECK (RejectedQty >= 0.00) ) CREATE TABLE PurchaseOrderHeader( PurchaseOrderID SERIAL NOT NULL, RevisionNumber smallint NOT NULL CONSTRAINT "DF_PurchaseOrderHeader_RevisionNumber" DEFAULT (0), Status smallint NOT NULL CONSTRAINT "DF_PurchaseOrderHeader_Status" DEFAULT (1), EmployeeID INT NOT NULL, VendorID INT NOT NULL, ShipMethodID INT NOT NULL, OrderDate TIMESTAMP NOT NULL CONSTRAINT "DF_PurchaseOrderHeader_OrderDate" DEFAULT (NOW()), ShipDate TIMESTAMP NULL, SubTotal numeric NOT NULL CONSTRAINT "DF_PurchaseOrderHeader_SubTotal" DEFAULT (0.00), TaxAmt numeric NOT NULL CONSTRAINT "DF_PurchaseOrderHeader_TaxAmt" DEFAULT (0.00), Freight numeric NOT NULL CONSTRAINT "DF_PurchaseOrderHeader_Freight" DEFAULT (0.00), TotalDue numeric, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_PurchaseOrderHeader_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_PurchaseOrderHeader_Status" CHECK (Status BETWEEN 1 AND 4), CONSTRAINT "CK_PurchaseOrderHeader_ShipDate" CHECK ((ShipDate >= OrderDate) OR (ShipDate IS NULL)), CONSTRAINT "CK_PurchaseOrderHeader_SubTotal" CHECK (SubTotal >= 0.00), CONSTRAINT "CK_PurchaseOrderHeader_TaxAmt" CHECK (TaxAmt >= 0.00), CONSTRAINT "CK_PurchaseOrderHeader_Freight" CHECK (Freight >= 0.00) ) CREATE TABLE ShipMethod( ShipMethodID SERIAL NOT NULL, Name "Name" NOT NULL, ShipBase numeric NOT NULL CONSTRAINT "DF_ShipMethod_ShipBase" DEFAULT (0.00), ShipRate numeric NOT NULL CONSTRAINT "DF_ShipMethod_ShipRate" DEFAULT (0.00), rowguid uuid NOT NULL CONSTRAINT "DF_ShipMethod_rowguid" DEFAULT (uuid_generate_v1()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_ShipMethod_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_ShipMethod_ShipBase" CHECK (ShipBase > 0.00), CONSTRAINT "CK_ShipMethod_ShipRate" CHECK (ShipRate > 0.00) ) CREATE TABLE Vendor( BusinessEntityID INT NOT NULL, AccountNumber "AccountNumber" NOT NULL, Name "Name" NOT NULL, CreditRating smallint NOT NULL, PreferredVendorStatus "Flag" NOT NULL CONSTRAINT "DF_Vendor_PreferredVendorStatus" DEFAULT (true), ActiveFlag "Flag" NOT NULL CONSTRAINT "DF_Vendor_ActiveFlag" DEFAULT (true), PurchasingWebServiceURL varchar(1024) NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_Vendor_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_Vendor_CreditRating" CHECK (CreditRating BETWEEN 1 AND 5) );
...
CREATE SCHEMA Sales CREATE TABLE CountryRegionCurrency( CountryRegionCode varchar(3) NOT NULL, CurrencyCode char(3) NOT NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_CountryRegionCurrency_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE CreditCard( CreditCardID SERIAL NOT NULL, CardType varchar(50) NOT NULL, CardNumber varchar(25) NOT NULL, ExpMonth smallint NOT NULL, ExpYear smallint NOT NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_CreditCard_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE Currency( CurrencyCode char(3) NOT NULL, Name "Name" NOT NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_Currency_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE CurrencyRate( CurrencyRateID SERIAL NOT NULL, CurrencyRateDate TIMESTAMP NOT NULL, FromCurrencyCode char(3) NOT NULL, ToCurrencyCode char(3) NOT NULL, AverageRate numeric NOT NULL, EndOfDayRate numeric NOT NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_CurrencyRate_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE Customer( CustomerID SERIAL NOT NULL, PersonID INT NULL, StoreID INT NULL, TerritoryID INT NULL, AccountNumber VARCHAR, rowguid uuid NOT NULL CONSTRAINT "DF_Customer_rowguid" DEFAULT (uuid_generate_v1()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_Customer_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE PersonCreditCard( BusinessEntityID INT NOT NULL, CreditCardID INT NOT NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_PersonCreditCard_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE SalesOrderDetail( SalesOrderID INT NOT NULL, SalesOrderDetailID SERIAL NOT NULL, CarrierTrackingNumber varchar(25) NULL, OrderQty smallint NOT NULL, ProductID INT NOT NULL, SpecialOfferID INT NOT NULL, UnitPrice numeric NOT NULL, UnitPriceDiscount numeric NOT NULL CONSTRAINT "DF_SalesOrderDetail_UnitPriceDiscount" DEFAULT (0.0), LineTotal numeric, rowguid uuid NOT NULL CONSTRAINT "DF_SalesOrderDetail_rowguid" DEFAULT (uuid_generate_v1()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_SalesOrderDetail_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_SalesOrderDetail_OrderQty" CHECK (OrderQty > 0), CONSTRAINT "CK_SalesOrderDetail_UnitPrice" CHECK (UnitPrice >= 0.00), CONSTRAINT "CK_SalesOrderDetail_UnitPriceDiscount" CHECK (UnitPriceDiscount >= 0.00) ) CREATE TABLE SalesOrderHeader( SalesOrderID SERIAL NOT NULL, RevisionNumber smallint NOT NULL CONSTRAINT "DF_SalesOrderHeader_RevisionNumber" DEFAULT (0), OrderDate TIMESTAMP NOT NULL CONSTRAINT "DF_SalesOrderHeader_OrderDate" DEFAULT (NOW()), DueDate TIMESTAMP NOT NULL, ShipDate TIMESTAMP NULL, Status smallint NOT NULL CONSTRAINT "DF_SalesOrderHeader_Status" DEFAULT (1), OnlineOrderFlag "Flag" NOT NULL CONSTRAINT "DF_SalesOrderHeader_OnlineOrderFlag" DEFAULT (true), SalesOrderNumber VARCHAR(23), PurchaseOrderNumber "OrderNumber" NULL, AccountNumber "AccountNumber" NULL, CustomerID INT NOT NULL, SalesPersonID INT NULL, TerritoryID INT NULL, BillToAddressID INT NOT NULL, ShipToAddressID INT NOT NULL, ShipMethodID INT NOT NULL, CreditCardID INT NULL, CreditCardApprovalCode varchar(15) NULL, CurrencyRateID INT NULL, SubTotal numeric NOT NULL CONSTRAINT "DF_SalesOrderHeader_SubTotal" DEFAULT (0.00), TaxAmt numeric NOT NULL CONSTRAINT "DF_SalesOrderHeader_TaxAmt" DEFAULT (0.00), Freight numeric NOT NULL CONSTRAINT "DF_SalesOrderHeader_Freight" DEFAULT (0.00), TotalDue numeric, Comment varchar(128) NULL, rowguid uuid NOT NULL CONSTRAINT "DF_SalesOrderHeader_rowguid" DEFAULT (uuid_generate_v1()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_SalesOrderHeader_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_SalesOrderHeader_Status" CHECK (Status BETWEEN 0 AND 8), CONSTRAINT "CK_SalesOrderHeader_DueDate" CHECK (DueDate >= OrderDate), CONSTRAINT "CK_SalesOrderHeader_ShipDate" CHECK ((ShipDate >= OrderDate) OR (ShipDate IS NULL)), CONSTRAINT "CK_SalesOrderHeader_SubTotal" CHECK (SubTotal >= 0.00), CONSTRAINT "CK_SalesOrderHeader_TaxAmt" CHECK (TaxAmt >= 0.00), CONSTRAINT "CK_SalesOrderHeader_Freight" CHECK (Freight >= 0.00) ) CREATE TABLE SalesOrderHeaderSalesReason( SalesOrderID INT NOT NULL, SalesReasonID INT NOT NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_SalesOrderHeaderSalesReason_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE SalesPerson( BusinessEntityID INT NOT NULL, TerritoryID INT NULL, SalesQuota numeric NULL, Bonus numeric NOT NULL CONSTRAINT "DF_SalesPerson_Bonus" DEFAULT (0.00), CommissionPct numeric NOT NULL CONSTRAINT "DF_SalesPerson_CommissionPct" DEFAULT (0.00), SalesYTD numeric NOT NULL CONSTRAINT "DF_SalesPerson_SalesYTD" DEFAULT (0.00), SalesLastYear numeric NOT NULL CONSTRAINT "DF_SalesPerson_SalesLastYear" DEFAULT (0.00), rowguid uuid NOT NULL CONSTRAINT "DF_SalesPerson_rowguid" DEFAULT (uuid_generate_v1()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_SalesPerson_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_SalesPerson_SalesQuota" CHECK (SalesQuota > 0.00), CONSTRAINT "CK_SalesPerson_Bonus" CHECK (Bonus >= 0.00), CONSTRAINT "CK_SalesPerson_CommissionPct" CHECK (CommissionPct >= 0.00), CONSTRAINT "CK_SalesPerson_SalesYTD" CHECK (SalesYTD >= 0.00), CONSTRAINT "CK_SalesPerson_SalesLastYear" CHECK (SalesLastYear >= 0.00) ) CREATE TABLE SalesPersonQuotaHistory( BusinessEntityID INT NOT NULL, QuotaDate TIMESTAMP NOT NULL, SalesQuota numeric NOT NULL, rowguid uuid NOT NULL CONSTRAINT "DF_SalesPersonQuotaHistory_rowguid" DEFAULT (uuid_generate_v1()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_SalesPersonQuotaHistory_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_SalesPersonQuotaHistory_SalesQuota" CHECK (SalesQuota > 0.00) ) CREATE TABLE SalesReason( SalesReasonID SERIAL NOT NULL, Name "Name" NOT NULL, ReasonType "Name" NOT NULL, ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_SalesReason_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE SalesTaxRate( SalesTaxRateID SERIAL NOT NULL, StateProvinceID INT NOT NULL, TaxType smallint NOT NULL, TaxRate numeric NOT NULL CONSTRAINT "DF_SalesTaxRate_TaxRate" DEFAULT (0.00), Name "Name" NOT NULL, rowguid uuid NOT NULL CONSTRAINT "DF_SalesTaxRate_rowguid" DEFAULT (uuid_generate_v1()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_SalesTaxRate_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_SalesTaxRate_TaxType" CHECK (TaxType BETWEEN 1 AND 3) ) CREATE TABLE SalesTerritory( TerritoryID SERIAL NOT NULL, Name "Name" NOT NULL, CountryRegionCode varchar(3) NOT NULL, "group" varchar(50) NOT NULL, SalesYTD numeric NOT NULL CONSTRAINT "DF_SalesTerritory_SalesYTD" DEFAULT (0.00), SalesLastYear numeric NOT NULL CONSTRAINT "DF_SalesTerritory_SalesLastYear" DEFAULT (0.00), CostYTD numeric NOT NULL CONSTRAINT "DF_SalesTerritory_CostYTD" DEFAULT (0.00), CostLastYear numeric NOT NULL CONSTRAINT "DF_SalesTerritory_CostLastYear" DEFAULT (0.00), rowguid uuid NOT NULL CONSTRAINT "DF_SalesTerritory_rowguid" DEFAULT (uuid_generate_v1()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_SalesTerritory_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_SalesTerritory_SalesYTD" CHECK (SalesYTD >= 0.00), CONSTRAINT "CK_SalesTerritory_SalesLastYear" CHECK (SalesLastYear >= 0.00), CONSTRAINT "CK_SalesTerritory_CostYTD" CHECK (CostYTD >= 0.00), CONSTRAINT "CK_SalesTerritory_CostLastYear" CHECK (CostLastYear >= 0.00) ) CREATE TABLE SalesTerritoryHistory( BusinessEntityID INT NOT NULL, TerritoryID INT NOT NULL, StartDate TIMESTAMP NOT NULL, EndDate TIMESTAMP NULL, rowguid uuid NOT NULL CONSTRAINT "DF_SalesTerritoryHistory_rowguid" DEFAULT (uuid_generate_v1()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_SalesTerritoryHistory_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_SalesTerritoryHistory_EndDate" CHECK ((EndDate >= StartDate) OR (EndDate IS NULL)) ) CREATE TABLE ShoppingCartItem( ShoppingCartItemID SERIAL NOT NULL, ShoppingCartID varchar(50) NOT NULL, Quantity INT NOT NULL CONSTRAINT "DF_ShoppingCartItem_Quantity" DEFAULT (1), ProductID INT NOT NULL, DateCreated TIMESTAMP NOT NULL CONSTRAINT "DF_ShoppingCartItem_DateCreated" DEFAULT (NOW()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_ShoppingCartItem_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_ShoppingCartItem_Quantity" CHECK (Quantity >= 1) ) CREATE TABLE SpecialOffer( SpecialOfferID SERIAL NOT NULL, Description varchar(255) NOT NULL, DiscountPct numeric NOT NULL CONSTRAINT "DF_SpecialOffer_DiscountPct" DEFAULT (0.00), Type varchar(50) NOT NULL, Category varchar(50) NOT NULL, StartDate TIMESTAMP NOT NULL, EndDate TIMESTAMP NOT NULL, MinQty INT NOT NULL CONSTRAINT "DF_SpecialOffer_MinQty" DEFAULT (0), MaxQty INT NULL, rowguid uuid NOT NULL CONSTRAINT "DF_SpecialOffer_rowguid" DEFAULT (uuid_generate_v1()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_SpecialOffer_ModifiedDate" DEFAULT (NOW()), CONSTRAINT "CK_SpecialOffer_EndDate" CHECK (EndDate >= StartDate), CONSTRAINT "CK_SpecialOffer_DiscountPct" CHECK (DiscountPct >= 0.00), CONSTRAINT "CK_SpecialOffer_MinQty" CHECK (MinQty >= 0), CONSTRAINT "CK_SpecialOffer_MaxQty" CHECK (MaxQty >= 0) ) CREATE TABLE SpecialOfferProduct( SpecialOfferID INT NOT NULL, ProductID INT NOT NULL, rowguid uuid NOT NULL CONSTRAINT "DF_SpecialOfferProduct_rowguid" DEFAULT (uuid_generate_v1()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_SpecialOfferProduct_ModifiedDate" DEFAULT (NOW()) ) CREATE TABLE Store( BusinessEntityID INT NOT NULL, Name "Name" NOT NULL, SalesPersonID INT NULL, Demographics XML NULL, rowguid uuid NOT NULL CONSTRAINT "DF_Store_rowguid" DEFAULT (uuid_generate_v1()), ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_Store_ModifiedDate" DEFAULT (NOW()) );
...
ALTER TABLE Person.AddressType ADD CONSTRAINT "PK_AddressType_AddressTypeID" PRIMARY KEY (AddressTypeID);

CLUSTER Person.AddressType USING "PK_AddressType_AddressTypeID";

ALTER TABLE Production.BillOfMaterials ADD CONSTRAINT "PK_BillOfMaterials_BillOfMaterialsID" PRIMARY KEY (BillOfMaterialsID);

ALTER TABLE Person.BusinessEntity ADD CONSTRAINT "PK_BusinessEntity_BusinessEntityID" PRIMARY KEY (BusinessEntityID);

CLUSTER Person.BusinessEntity USING "PK_BusinessEntity_BusinessEntityID";

ALTER TABLE Person.BusinessEntityAddress ADD CONSTRAINT "PK_BusinessEntityAddress_BusinessEntityID_AddressID_AddressType" PRIMARY KEY (BusinessEntityID, AddressID, AddressTypeID);

CLUSTER Person.BusinessEntityAddress USING "PK_BusinessEntityAddress_BusinessEntityID_AddressID_AddressType";

ALTER TABLE Person.BusinessEntityContact ADD CONSTRAINT "PK_BusinessEntityContact_BusinessEntityID_PersonID_ContactTypeI" PRIMARY KEY (BusinessEntityID, PersonID, ContactTypeID);

CLUSTER Person.BusinessEntityContact USING "PK_BusinessEntityContact_BusinessEntityID_PersonID_ContactTypeI";

ALTER TABLE Person.ContactType ADD CONSTRAINT "PK_ContactType_ContactTypeID" PRIMARY KEY (ContactTypeID);

CLUSTER Person.ContactType USING "PK_ContactType_ContactTypeID";

ALTER TABLE Sales.CountryRegionCurrency ADD CONSTRAINT "PK_CountryRegionCurrency_CountryRegionCode_CurrencyCode" PRIMARY KEY (CountryRegionCode, CurrencyCode);

CLUSTER Sales.CountryRegionCurrency USING "PK_CountryRegionCurrency_CountryRegionCode_CurrencyCode";

ALTER TABLE Person.CountryRegion ADD CONSTRAINT "PK_CountryRegion_CountryRegionCode" PRIMARY KEY (CountryRegionCode);

CLUSTER Person.CountryRegion USING "PK_CountryRegion_CountryRegionCode";

ALTER TABLE Sales.CreditCard ADD CONSTRAINT "PK_CreditCard_CreditCardID" PRIMARY KEY (CreditCardID);

CLUSTER Sales.CreditCard USING "PK_CreditCard_CreditCardID";

ALTER TABLE Sales.Currency ADD CONSTRAINT "PK_Currency_CurrencyCode" PRIMARY KEY (CurrencyCode);

CLUSTER Sales.Currency USING "PK_Currency_CurrencyCode";

ALTER TABLE Sales.CurrencyRate ADD CONSTRAINT "PK_CurrencyRate_CurrencyRateID" PRIMARY KEY (CurrencyRateID);

CLUSTER Sales.CurrencyRate USING "PK_CurrencyRate_CurrencyRateID";

ALTER TABLE Sales.Customer ADD CONSTRAINT "PK_Customer_CustomerID" PRIMARY KEY (CustomerID);

CLUSTER Sales.Customer USING "PK_Customer_CustomerID";

ALTER TABLE Production.Culture ADD CONSTRAINT "PK_Culture_CultureID" PRIMARY KEY (CultureID);

CLUSTER Production.Culture USING "PK_Culture_CultureID";

ALTER TABLE Production.Document ADD CONSTRAINT "PK_Document_DocumentNode" PRIMARY KEY (DocumentNode);

CLUSTER Production.Document USING "PK_Document_DocumentNode";

ALTER TABLE Person.EmailAddress ADD CONSTRAINT "PK_EmailAddress_BusinessEntityID_EmailAddressID" PRIMARY KEY (BusinessEntityID, EmailAddressID);

CLUSTER Person.EmailAddress USING "PK_EmailAddress_BusinessEntityID_EmailAddressID";

ALTER TABLE HumanResources.Department ADD CONSTRAINT "PK_Department_DepartmentID" PRIMARY KEY (DepartmentID);

CLUSTER HumanResources.Department USING "PK_Department_DepartmentID";

ALTER TABLE HumanResources.Employee ADD CONSTRAINT "PK_Employee_BusinessEntityID" PRIMARY KEY (BusinessEntityID);

CLUSTER HumanResources.Employee USING "PK_Employee_BusinessEntityID";

ALTER TABLE HumanResources.EmployeeDepartmentHistory ADD CONSTRAINT "PK_EmployeeDepartmentHistory_BusinessEntityID_StartDate_Departm" PRIMARY KEY (BusinessEntityID, StartDate, DepartmentID, ShiftID);

CLUSTER HumanResources.EmployeeDepartmentHistory USING "PK_EmployeeDepartmentHistory_BusinessEntityID_StartDate_Departm";

ALTER TABLE HumanResources.EmployeePayHistory ADD CONSTRAINT "PK_EmployeePayHistory_BusinessEntityID_RateChangeDate" PRIMARY KEY (BusinessEntityID, RateChangeDate);

CLUSTER HumanResources.EmployeePayHistory USING "PK_EmployeePayHistory_BusinessEntityID_RateChangeDate";

ALTER TABLE HumanResources.JobCandidate ADD CONSTRAINT "PK_JobCandidate_JobCandidateID" PRIMARY KEY (JobCandidateID);

CLUSTER HumanResources.JobCandidate USING "PK_JobCandidate_JobCandidateID";

ALTER TABLE Production.Illustration ADD CONSTRAINT "PK_Illustration_IllustrationID" PRIMARY KEY (IllustrationID);

CLUSTER Production.Illustration USING "PK_Illustration_IllustrationID";

ALTER TABLE Production.Location ADD CONSTRAINT "PK_Location_LocationID" PRIMARY KEY (LocationID);

CLUSTER Production.Location USING "PK_Location_LocationID";

ALTER TABLE Person.Password ADD CONSTRAINT "PK_Password_BusinessEntityID" PRIMARY KEY (BusinessEntityID);

CLUSTER Person.Password USING "PK_Password_BusinessEntityID";

ALTER TABLE Person.Person ADD CONSTRAINT "PK_Person_BusinessEntityID" PRIMARY KEY (BusinessEntityID);

CLUSTER Person.Person USING "PK_Person_BusinessEntityID";

ALTER TABLE Person.PersonPhone ADD CONSTRAINT "PK_PersonPhone_BusinessEntityID_PhoneNumber_PhoneNumberTypeID" PRIMARY KEY (BusinessEntityID, PhoneNumber, PhoneNumberTypeID);

CLUSTER Person.PersonPhone USING "PK_PersonPhone_BusinessEntityID_PhoneNumber_PhoneNumberTypeID";

ALTER TABLE Person.PhoneNumberType ADD CONSTRAINT "PK_PhoneNumberType_PhoneNumberTypeID" PRIMARY KEY (PhoneNumberTypeID);

CLUSTER Person.PhoneNumberType USING "PK_PhoneNumberType_PhoneNumberTypeID";

ALTER TABLE Production.Product ADD CONSTRAINT "PK_Product_ProductID" PRIMARY KEY (ProductID);

CLUSTER Production.Product USING "PK_Product_ProductID";

ALTER TABLE Production.ProductCategory ADD CONSTRAINT "PK_ProductCategory_ProductCategoryID" PRIMARY KEY (ProductCategoryID);

CLUSTER Production.ProductCategory USING "PK_ProductCategory_ProductCategoryID";

ALTER TABLE Production.ProductCostHistory ADD CONSTRAINT "PK_ProductCostHistory_ProductID_StartDate" PRIMARY KEY (ProductID, StartDate);

CLUSTER Production.ProductCostHistory USING "PK_ProductCostHistory_ProductID_StartDate";

ALTER TABLE Production.ProductDescription ADD CONSTRAINT "PK_ProductDescription_ProductDescriptionID" PRIMARY KEY (ProductDescriptionID);

CLUSTER Production.ProductDescription USING "PK_ProductDescription_ProductDescriptionID";

ALTER TABLE Production.ProductDocument ADD CONSTRAINT "PK_ProductDocument_ProductID_DocumentNode" PRIMARY KEY (ProductID, DocumentNode);

CLUSTER Production.ProductDocument USING "PK_ProductDocument_ProductID_DocumentNode";

ALTER TABLE Production.ProductInventory ADD CONSTRAINT "PK_ProductInventory_ProductID_LocationID" PRIMARY KEY (ProductID, LocationID);

CLUSTER Production.ProductInventory USING "PK_ProductInventory_ProductID_LocationID";

ALTER TABLE Production.ProductListPriceHistory ADD CONSTRAINT "PK_ProductListPriceHistory_ProductID_StartDate" PRIMARY KEY (ProductID, StartDate);

CLUSTER Production.ProductListPriceHistory USING "PK_ProductListPriceHistory_ProductID_StartDate";

ALTER TABLE Production.ProductModel ADD CONSTRAINT "PK_ProductModel_ProductModelID" PRIMARY KEY (ProductModelID);

CLUSTER Production.ProductModel USING "PK_ProductModel_ProductModelID";

ALTER TABLE Production.ProductModelIllustration ADD CONSTRAINT "PK_ProductModelIllustration_ProductModelID_IllustrationID" PRIMARY KEY (ProductModelID, IllustrationID);

CLUSTER Production.ProductModelIllustration USING "PK_ProductModelIllustration_ProductModelID_IllustrationID";

ALTER TABLE Production.ProductModelProductDescriptionCulture ADD CONSTRAINT "PK_ProductModelProductDescriptionCulture_ProductModelID_Product" PRIMARY KEY (ProductModelID, ProductDescriptionID, CultureID);
...
ALTER TABLE Production.ProductPhoto ADD CONSTRAINT "PK_ProductPhoto_ProductPhotoID" PRIMARY KEY (ProductPhotoID);
...
ALTER TABLE Production.ProductSubcategory ADD CONSTRAINT "PK_ProductSubcategory_ProductSubcategoryID" PRIMARY KEY (ProductSubcategoryID);

CLUSTER Production.ProductSubcategory USING "PK_ProductSubcategory_ProductSubcategoryID";

ALTER TABLE Purchasing.ProductVendor ADD CONSTRAINT "PK_ProductVendor_ProductID_BusinessEntityID" PRIMARY KEY (ProductID, BusinessEntityID);

CLUSTER Purchasing.ProductVendor USING "PK_ProductVendor_ProductID_BusinessEntityID";

ALTER TABLE Purchasing.PurchaseOrderDetail ADD CONSTRAINT "PK_PurchaseOrderDetail_PurchaseOrderID_PurchaseOrderDetailID" PRIMARY KEY (PurchaseOrderID, PurchaseOrderDetailID);

CLUSTER Purchasing.PurchaseOrderDetail USING "PK_PurchaseOrderDetail_PurchaseOrderID_PurchaseOrderDetailID";

ALTER TABLE Purchasing.PurchaseOrderHeader ADD CONSTRAINT "PK_PurchaseOrderHeader_PurchaseOrderID" PRIMARY KEY (PurchaseOrderID);

CLUSTER Purchasing.PurchaseOrderHeader USING "PK_PurchaseOrderHeader_PurchaseOrderID";

ALTER TABLE Sales.PersonCreditCard ADD CONSTRAINT "PK_PersonCreditCard_BusinessEntityID_CreditCardID" PRIMARY KEY (BusinessEntityID, CreditCardID);

CLUSTER Sales.PersonCreditCard USING "PK_PersonCreditCard_BusinessEntityID_CreditCardID";

ALTER TABLE Sales.SalesOrderDetail ADD CONSTRAINT "PK_SalesOrderDetail_SalesOrderID_SalesOrderDetailID" PRIMARY KEY (SalesOrderID, SalesOrderDetailID);

CLUSTER Sales.SalesOrderDetail USING "PK_SalesOrderDetail_SalesOrderID_SalesOrderDetailID";

ALTER TABLE Sales.SalesOrderHeader ADD CONSTRAINT "PK_SalesOrderHeader_SalesOrderID" PRIMARY KEY (SalesOrderID);

CLUSTER Sales.SalesOrderHeader USING "PK_SalesOrderHeader_SalesOrderID";

ALTER TABLE Sales.SalesOrderHeaderSalesReason ADD CONSTRAINT "PK_SalesOrderHeaderSalesReason_SalesOrderID_SalesReasonID" PRIMARY KEY (SalesOrderID, SalesReasonID);

CLUSTER Sales.SalesOrderHeaderSalesReason USING "PK_SalesOrderHeaderSalesReason_SalesOrderID_SalesReasonID";

ALTER TABLE Sales.SalesPerson ADD CONSTRAINT "PK_SalesPerson_BusinessEntityID" PRIMARY KEY (BusinessEntityID);

CLUSTER Sales.SalesPerson USING "PK_SalesPerson_BusinessEntityID";

ALTER TABLE Sales.SalesPersonQuotaHistory ADD CONSTRAINT "PK_SalesPersonQuotaHistory_BusinessEntityID_QuotaDate" PRIMARY KEY (BusinessEntityID, QuotaDate);

CLUSTER Sales.SalesPersonQuotaHistory USING "PK_SalesPersonQuotaHistory_BusinessEntityID_QuotaDate";

ALTER TABLE Sales.SalesReason ADD CONSTRAINT "PK_SalesReason_SalesReasonID" PRIMARY KEY (SalesReasonID);

CLUSTER Sales.SalesReason USING "PK_SalesReason_SalesReasonID";

ALTER TABLE Sales.SalesTaxRate ADD CONSTRAINT "PK_SalesTaxRate_SalesTaxRateID" PRIMARY KEY (SalesTaxRateID);

CLUSTER Sales.SalesTaxRate USING "PK_SalesTaxRate_SalesTaxRateID";

ALTER TABLE Sales.SalesTerritory ADD CONSTRAINT "PK_SalesTerritory_TerritoryID" PRIMARY KEY (TerritoryID);
...
ALTER TABLE Production.ScrapReason ADD CONSTRAINT "PK_ScrapReason_ScrapReasonID" PRIMARY KEY (ScrapReasonID);

CLUSTER Production.ScrapReason USING "PK_ScrapReason_ScrapReasonID";

ALTER TABLE HumanResources.Shift ADD CONSTRAINT "PK_Shift_ShiftID" PRIMARY KEY (ShiftID);

CLUSTER HumanResources.Shift USING "PK_Shift_ShiftID";

ALTER TABLE Purchasing.ShipMethod ADD CONSTRAINT "PK_ShipMethod_ShipMethodID" PRIMARY KEY (ShipMethodID);

CLUSTER Purchasing.ShipMethod USING "PK_ShipMethod_ShipMethodID";

ALTER TABLE Sales.ShoppingCartItem ADD CONSTRAINT "PK_ShoppingCartItem_ShoppingCartItemID" PRIMARY KEY (ShoppingCartItemID);

CLUSTER Sales.ShoppingCartItem USING "PK_ShoppingCartItem_ShoppingCartItemID";

ALTER TABLE Sales.SpecialOffer ADD CONSTRAINT "PK_SpecialOffer_SpecialOfferID" PRIMARY KEY (SpecialOfferID);

CLUSTER Sales.SpecialOffer USING "PK_SpecialOffer_SpecialOfferID";

ALTER TABLE Sales.SpecialOfferProduct ADD CONSTRAINT "PK_SpecialOfferProduct_SpecialOfferID_ProductID" PRIMARY KEY (SpecialOfferID, ProductID);

CLUSTER Sales.SpecialOfferProduct USING "PK_SpecialOfferProduct_SpecialOfferID_ProductID";

ALTER TABLE Person.StateProvince ADD CONSTRAINT "PK_StateProvince_StateProvinceID" PRIMARY KEY (StateProvinceID);
...
ALTER TABLE Production.TransactionHistory ADD CONSTRAINT "PK_TransactionHistory_TransactionID" PRIMARY KEY (TransactionID);

CLUSTER Production.TransactionHistory USING "PK_TransactionHistory_TransactionID";

ALTER TABLE Production.TransactionHistoryArchive ADD CONSTRAINT "PK_TransactionHistoryArchive_TransactionID" PRIMARY KEY (TransactionID);

CLUSTER Production.TransactionHistoryArchive USING "PK_TransactionHistoryArchive_TransactionID";

ALTER TABLE Production.UnitMeasure ADD CONSTRAINT "PK_UnitMeasure_UnitMeasureCode" PRIMARY KEY (UnitMeasureCode);

CLUSTER Production.UnitMeasure USING "PK_UnitMeasure_UnitMeasureCode";

ALTER TABLE Purchasing.Vendor ADD CONSTRAINT "PK_Vendor_BusinessEntityID" PRIMARY KEY (BusinessEntityID);

CLUSTER Purchasing.Vendor USING "PK_Vendor_BusinessEntityID";

ALTER TABLE Production.WorkOrder ADD CONSTRAINT "PK_WorkOrder_WorkOrderID" PRIMARY KEY (WorkOrderID);

CLUSTER Production.WorkOrder USING "PK_WorkOrder_WorkOrderID";

ALTER TABLE Production.WorkOrderRouting ADD CONSTRAINT "PK_WorkOrderRouting_WorkOrderID_ProductID_OperationSequence" PRIMARY KEY (WorkOrderID, ProductID, OperationSequence);
...
ALTER TABLE Production.ProductModelProductDescriptionCulture ADD CONSTRAINT "FK_ProductModelProductDescriptionCulture_ProductDescription_Pro" FOREIGN KEY (ProductDescriptionID) REFERENCES Production.ProductDescription(ProductDescriptionID);
...
ALTER TABLE Production.ProductModelProductDescriptionCulture ADD CONSTRAINT "FK_ProductModelProductDescriptionCulture_ProductModel_ProductMo" FOREIGN KEY (ProductModelID) REFERENCES Production.ProductModel(ProductModelID);
...
CREATE VIEW Production.vProductModelInstructions AS SELECT pm.ProductModelID ,pm.Name ,(xpath('/ns:root/text()', pm.Instructions, '{{ns,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelManuInstructions}}'))[1]::varchar AS Instructions ,CAST((xpath('@LocationID', pm.MfgInstructions))[1]::varchar AS INTEGER) AS "LocationID" ,CAST((xpath('@SetupHours', pm.MfgInstructions))[1]::varchar AS DECIMAL(9, 4)) AS "SetupHours" ,CAST((xpath('@MachineHours', pm.MfgInstructions))[1]::varchar AS DECIMAL(9, 4)) AS "MachineHours" ,CAST((xpath('@LaborHours', pm.MfgInstructions))[1]::varchar AS DECIMAL(9, 4)) AS "LaborHours" ,CAST((xpath('@LotSize', pm.MfgInstructions))[1]::varchar AS INTEGER) AS "LotSize" ,(xpath('/step/text()', pm.Step))[1]::varchar(1024) AS "Step" ,pm.rowguid ,pm.ModifiedDate FROM (SELECT locations.ProductModelID, locations.Name, locations.rowguid, locations.ModifiedDate ,locations.Instructions, locations.MfgInstructions ,UNNEST(xpath('step', locations.MfgInstructions)) AS Step FROM (SELECT ProductModelID, Name, rowguid, ModifiedDate, Instructions ,UNNEST(xpath('/ns:root/ns:Location', Instructions, '{{ns,http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelManuInstructions}}')) AS MfgInstructions FROM Production.ProductModel) AS locations) AS pm;
